...
@include('sidebar')
  ...
  <body class="allCategories-body">
    <!--TABS ab hier -->
    <div class="tab-body row col-md-12 ml-0">
        ...
        <ul class=" nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="index-cards-tab" data-toggle="tab" href="#index-cards" role="tab" aria-controls="index-cards" aria-selected="false">Karteikarten</a>
          </li>
